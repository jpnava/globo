...
class UseresSessionesControllerTest < ActionController::TestCase
  setup do
    @user_session = useres_sessiones(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:useres_sessiones)
  end
  ...
  test "should destroy user_session" do
    ...
    assert_redirected_to useres_sessiones_path
  end
end
